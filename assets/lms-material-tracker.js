(function () {
  ...
  function setCompleteVisual(key, completed) {
    completeButtons(key).forEach(function (button) {
      ...
      button.textContent = completed ? '학습완료 확인됨!' : '학습완료 후 클릭!';
