(function () {
  ...
  function injectPanel() {
    ...
    style.textContent = '#learning-record-panel{position:relative;z-index:4;display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin:0 auto 20px;padding:14px 16px;max-width:1440px;border:1px solid #c7e3e8;border-radius:14px;background:#f8fdfe;color:#10253d;font:14px Arial,"Noto Sans KR",sans-serif}#learning-record-panel strong{color:#147fa4;margin-right:8px}#learning-record-panel [data-learning-title]{color:#587080}#learning-record-panel label{display:flex;align-items:center;gap:6px}#learning-record-panel input[type=range]{width:130px}#learning-record-panel output{min-width:38px}#learning-record-panel textarea{flex:1;min-width:180px;min-height:38px;padding:8px;border:1px solid #b9d8df;border-radius:8px;font:inherit}#learning-record-panel button,.learning-completion-button{padding:10px 14px;border:0;border-radius:8px;background:#147fa4;color:#fff;font-weight:800;cursor:pointer}.learning-completion-button{display:block;margin:18px auto 8px;position:relative;overflow:hidden}.learning-completion-button.is-complete:after{content:"";position:absolute;left:5%;right:5%;top:50%;height:3px;background:#e11;transform:translateY(-50%);pointer-events:none}.learning-completion-button.is-complete{background:#587080}';
